...
const google          = 'www.googletagmanager.com www.google-analytics.com *.google-analytics.com *.googleadservices.com googleads.g.doubleclick.net *.googlesyndication.com';
...
const ContentSecurityPolicy = `
  default-src 'self';
  script-src 'self' 'unsafe-inline' 'unsafe-eval' ${midtransWild} ${midtransCdn} ${cloudflare} ${turnstile} ${google};
  ...
  img-src 'self' data: blob:
    ...
    ${midtransWild} ${midtransCdn} ${google} www.google.com www.google.co.id;
  frame-src 'self' ${midtransWild} ${midtransCdn} ${turnstile} ${google};
